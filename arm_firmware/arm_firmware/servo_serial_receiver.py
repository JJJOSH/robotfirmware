...
class ServoSerialReceiver(Node):
    def __init__(self):
        super().__init__("servo_serial_receiver")
...
def main():
    ...
    servo_serial_receiver = ServoSerialReceiver()
    rclpy.spin(servo_serial_receiver)
    
    servo_serial_receiver.destroy_node()
    rclpy.shutdown()
