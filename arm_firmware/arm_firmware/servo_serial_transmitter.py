...
class ServoSerialTransmitter(Node):
    def __init__(self):
        super().__init__("servo_serial_transmitter")
...
def main():
    ...
    servo_serial_transmitter = ServoSerialTransmitter()
    rclpy.spin(servo_serial_transmitter)
    
    servo_serial_transmitter.destroy_node()
    rclpy.shutdown()
